...
# --- Configuration ---
art_file="$HOME/.config/hypr/hyprlock/album_art.jpg"
fallback_art_file="$HOME/.config/hypr/hyprlock/fallback_album_art.jpg"
cache_file="$HOME/.config/hypr/hyprlock/song_title.cache"
